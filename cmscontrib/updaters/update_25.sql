...
begin
    execute format('update %s set %s = regexp_replace(%s, ''(,|^)c(,|$)'', ''\1C / gcc\2'')', tbl, par, par);
    execute format('update %s set %s = regexp_replace(%s, ''(,|^)cpp(,|$)'', ''\1C++ / g++\2'')', tbl, par, par);
    execute format('update %s set %s = regexp_replace(%s, ''(,|^)pas(,|$)'', ''\1Pascal / fpc\2'')', tbl, par, par);
    execute format('update %s set %s = regexp_replace(%s, ''(,|^)py(,|$)'', ''\1Python\2'')', tbl, par, par);
    execute format('update %s set %s = regexp_replace(%s, ''(,|^)php(,|$)'', ''\1PHP\2'')', tbl, par, par);
    execute format('update %s set %s = regexp_replace(%s, ''(,|^)java(,|$)'', ''\1Java / gcj\2'')', tbl, par, par);
